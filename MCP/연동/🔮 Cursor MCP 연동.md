...
## 🌐 GitHub 연동 방법<br>  
### 🛠️ Smithery 활용하기<br>  
[Smithery](https://smithery.ai/)는 각종 MCP 서버를 모아둔 사이트다. 여러 MCP 서버 중에서 필요한 것을 찾아 사용하면 된다.  
### 💻 GitHub MCP Server 설정<br>  
Smithery에서 GitHub로 검색한 다음 `@smithery-ai/github`를 클릭한다.  
### 🔑 GitHub 토큰 발급하기<br>  
